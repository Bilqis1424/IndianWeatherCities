...
def run_full_comparison():
    ...
    # ---- 1. Bar charts for both variables ----
    ...
    # Temperature
    sns.barplot(x=models, y=temp_r2, ax=axes[0,0], palette='viridis')
    axes[0,0].set_title('Temperature R²')
    sns.barplot(x=models, y=mae_temp, ax=axes[0,1], palette='magma')
    axes[0,1].set_title('Temperature MAE')
    sns.barplot(x=models, y=rmse_temp, ax=axes[0,2], palette='plasma')
    axes[0,2].set_title('Temperature RMSE')
    # Humidity
    sns.barplot(x=models, y=hum_r2, ax=axes[1,0], palette='viridis')
    axes[1,0].set_title('Humidity R²')
    sns.barplot(x=models, y=mae_hum, ax=axes[1,1], palette='magma')
    axes[1,1].set_title('Humidity MAE')
    sns.barplot(x=models, y=rmse_hum, ax=axes[1,2], palette='plasma')
